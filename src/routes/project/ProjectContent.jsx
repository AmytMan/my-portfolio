  ...
  return (
    <div className='projectcontact_container'>
        <div className='text_center'>
            ...
            <p>Discover a range of my projects with detailed description highlighting the  strategies and outcomes of each initiative. Gain valuable insights into my processes and methodologies for delivering successful projects, and explore how I can help you achieve your goals.</p>
        </div>
        ...
        <div className='projects_wrapper'>
            <div className='projects_menu'>
                ...
                <div className='project_details'>
                    ...
                    <button>
                        <a href="https://github.com/AmytMan/histudy" target='_blank'>See in Github</a> 
                    </button>
                </div>
            </div>
            ...
            <div className='projects_menu'>
                ...
                <div className='project_details'>
                    ...
                    <button>
                        <a href="https://github.com/AmytMan/my-portfolio" target="_blank">See in Github</a>
                    </button>
                </div>
            </div>
            ...
            <div className='projects_menu'>
                ...
                <div className='project_details'>
                    ...
                    <button>
                        <a href="https://github.com/AmytMan/digital-clock" target='_blank'>See in Github</a>
                    </button>
                </div>
            </div>
            ...
            <div className='projects_menu'>
                ...
                <div className='project_details'>
                    ...
                    <button>
                        <a href="https://github.com/AmytMan/Anime-generator"target='_blank'>See in Github</a>
                    </button>
                </div>
            </div>
